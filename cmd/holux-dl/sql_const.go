...
var (
	CREATE_TABLE = map[string]string{
		...
		"tracks":             `CREATE TABLE tracks ( id   INTEGER PRIMARY KEY, time TIMESTAMP NOT NULL, name TEXT,  "distance/m" INTEGER NOT NULL,  "duration/s" INTEGER NOT NULL  );`,
	}
	INSERT = map[string]string{
		...
		"track":      `INSERT INTO tracks(time, name, "distance/m", "duration/s") VALUES (?, ?, ?, ?);`,
	}
)
